...
<button name="cancel" onclick="location.href = '/faqs/faq_blocks/index/5?frame_id=11'" ng-click="sending=true" ng-disabled="sending" class="btn btn-info btn-workflow " type="button">
	<?php echo __d('calendars', '一時保存'); ?>
</button>
<br class="visible-xs" style="margin:5px" />
<button type="submit" ng-disabled="sending" class="btn btn-primary btn-workflow" name="save" ng-click="ok()">
