 ...
 */
	protected function _makeSchedulePlanSummariesHtml(&$vars, &$nctm, $year, $month, $day, $idx, &$cnt) {
		...
		return $this->getSchedulePlanSummariesHtml($vars, $year, $month, $day, $fromTimeOfDay, $toTimeOfDay, $plansOfDay, $idx, $cnt);
	}

/**
 * getSchedulePlanSummariesHtml
 *
 * 予定概要群html取得
 *
 * @param array &$vars カレンダー情報
 ...
 * @return string HTML
 */
	public function getSchedulePlanSummariesHtml(&$vars, $year, $month, $day, $fromTime, $toTime, $plans, $idx, &$cnt) {
		$html = '';
		$cnt = 0;
		$prevUser = '';
